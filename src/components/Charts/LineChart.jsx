...
function LineChart() {
    ...
    const primaryyAxis = { labelFormat: '${value}K',majorGridLines: { visible: false }, minorGridLines: { visible: false } };
    const primarxyAxis = { valueType: 'Category',majorGridLines: { visible: false }, minorGridLines: { visible: false } };
